...
namespace ETModel
{
    public sealed class Hot2 : Object
    {
#if ILRuntime
        ...
        public void LoadHotfixAssembly()
        {
            ...
            byte[] assBytes = code.Get<TextAsset>("Hot2.dll").bytes;
            byte[] pdbBytes = code.Get<TextAsset>("Hot2.pdb").bytes;

#if ILRuntime
            Log.Debug($"当前使用的是ILRuntime111模式");
            ...
            this.start = new ILStaticMethod(this.appDomain, "Hot2.Init", "Start", 0);
			...
			Type hotfixInit = this.assembly.GetType("Hot2.Init");
